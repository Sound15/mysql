...
select *
from transactionsfo inner join customers 
on transactionsfo.customer_id=customers.customer_id;

select *
from transactionsfo left join customers
on transactionsfo.customer_id=customers.customer_id;

select *
from transactionsfo right join customers
on transactionsfo.customer_id=customers.customer_id;